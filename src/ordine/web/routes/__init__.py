"""HTML route handlers for the Ordine web UI.
...
from ordine.web.flag_hints import hint_for_kind
from ordine.web.forms import validate_editor_content
from ordine.web.routes.dashboard import pipeline_cards
from ordine.web.routes.tasks import diagnosis_for_task
from ordine.web.security import resolve_artifact
from ordine.web.services import ServiceManager
from ordine.web.views import can_cancel, can_retry
...
async def task_detail(request: Request, task_id: int) -> HTMLResponse:
    ...
    from ordine.core.ledger import TERMINAL_TASK_STATUSES
